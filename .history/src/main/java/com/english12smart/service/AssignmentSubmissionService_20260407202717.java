...
public class AssignmentSubmissionService {
    ...
    public List<AssignmentSubmissionDTO.SubmissionListItemDTO> getSubmissionsByAssignment(
        ...
        log.info("Lấy submissions cho assignment: {}, teacher: {}", assignmentId, teacherId);
        ...
        if (assignment.getTeacherId() == null || !assignment.getTeacherId().equals(teacherId)) {
            log.warn("Teacher {} không có quyền xem bài nộp của assignment {}", teacherId, assignmentId);
        ...
        List<AssignmentSubmission> submissions = submissionRepository
                .findByAssignmentId(assignmentId);  // Simple query, will sort in memory
        ...
        submissions.sort((a, b) -> {
            ...
            return b.getSubmittedAt().compareTo(a.getSubmittedAt()); // DESC
        });
