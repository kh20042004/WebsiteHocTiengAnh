...
public class AssignmentSubmissionService {
    ...
    private AssignmentSubmissionDTO.SubmissionListItemDTO toSubmissionListItemDTO(
        ...
        try {
            ...
            log.error("Error converting submission {} to DTO: {}", submission.getId(), e.getMessage(), e);
            throw new RuntimeException("Lỗi khi chuyển đổi submission DTO: " + e.getMessage(), e);
        }
    }
