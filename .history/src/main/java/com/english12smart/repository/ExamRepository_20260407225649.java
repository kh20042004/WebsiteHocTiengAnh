...
public interface ExamRepository extends MongoRepository<Exam, String> {
    ...
    /**
     * Lấy danh sách đề thi của một giáo viên với phân trang, sắp xếp mới nhất trước
     * Dùng để hiển thị trên trang quản lý đề thi của giáo viên (có pagination)
     */
    Page<Exam> findByTeacherIdOrderByCreatedAtDesc(String teacherId, Pageable pageable);
